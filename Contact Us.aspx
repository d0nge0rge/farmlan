                ...
                <div class="item active">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated3">
                                <span style="color: #243B0B;"><strong></strong>Fame for the highest</span>
                            </h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul id="portfolio-list">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <div class="photoBox photoBox-standard" style="background-image: url('images/gallery/incin3.jpg')"></div>
        ...
        <div class="modal-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img src="images/gallery/swm.jpg" class="photoBox22" alt=".."/>
                    </div>
                    <div class="col-md-6">
                        <img src="images/gallery/SN Incinerstor.png" class="photoBox22" alt=".."/>
                    </div>
